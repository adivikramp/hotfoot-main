...
const HotelPricingScreen2 = ({ hotelData }) => {
  ...
  // Animate tab switch
  const switchTab = (tab) => {
    const toValue = tab === 'featured' ? 0 : width / 2 - 40;
          ...
          <SafeAreaView style={styles.modalContainer}>
            <View style={styles.modalContent}>
              ...
              <View style={styles.modalSourceInfo}>
                <Text style={styles.modalSourceName}>{data.source}</Text>
                {data.official && (
...
export default HotelPricingScreen2