    ...
    <View style={styles.container}>
      ...
      <View style={styles.tabWrapper}>
        <View style={styles.tabContainer}>
          ...
          <TouchableOpacity style={styles.tab} onPress={() => switchTab("all")}>
            <Text
              style={[
                styles.tabText,
      ...
      <FlatList
        ...
        renderItem={({ item }) => (
          <PriceCard data={item} showRooms={selectedTab === "featured"} />
        )}
        ...
        <View style={styles.priceMainInfo}>
          ...
          {data.rate_per_night?.before_taxes_fees && (
            <View style={styles.taxBadge}>
              <Text style={styles.taxesText}>Before taxes & fees</Text>
          ...
          <SafeAreaView style={styles.modalContainer}>
            <View style={styles.modalContent}>
              ...
              <FlatList
                ...
                renderItem={({ item }) => <RoomOptionCard room={item} />}
                ItemSeparatorComponent={() => (
                  <View style={styles.roomSeparator} />
                )}
    ...
    <View style={styles.roomOptionCard}>
      ...
      <View style={styles.roomOptionDetailsContainer}>
        ...
        <View style={styles.roomNameContainer}>
          ...
          <View style={styles.roomTypeBadge}>
            <Text style={styles.roomTypeText}>{room.type || "Standard"}</Text>
          </View>
        </View>
      ...
      <View style={styles.roomActionContainer}>
        ...
        <TouchableOpacity
          ...
          onPress={() => handleRoomSelect(room.link)}
          activeOpacity={0.7}
        >
